...
logtext(fid, 'trace', 'Applying BPM basic congfigurations and checking active units...');
...
logtext(fid, 'trace', 'Applying photon BPM basic congfigurations and checking active units...');
